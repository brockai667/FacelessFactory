...
def build_prompt(n, existing_titles):
    return (
        ...
        "- each segment 'keywords': 1-3 ENGLISH words, concrete and topic-locked so real, on-theme stock footage exists on Pexels "
        "(e.g. 'octopus underwater', 'galaxy space', 'person sleeping'). Avoid abstract words with no footage.\n"
